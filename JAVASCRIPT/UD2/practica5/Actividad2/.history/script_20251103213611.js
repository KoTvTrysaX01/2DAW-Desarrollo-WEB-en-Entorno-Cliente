window.onload = function (){
  ...
  fecha.addEventListener("change", esValidaFecha)
  hora.addEventListener("change", esValidaHora)
  tel.addEventListener("change",esValidoTel)
  ...
  form.addEventListener("submit",e => {
    const mensaje = this.confirm("Deseas confirmar el envio de datos?"
    if(!mensaje){
      e.preventDefault()
